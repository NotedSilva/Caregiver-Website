  ...
  return <div>
    <div>
        <h3 className="text-[20px] leading-[30px] text-headingColor font-semibold flex items-center gap-2">
            Sobre
            <span className="text-irisBlueColor font-bold text-[24px] leading-9">Gustavo Gomes</span>
            </h3>
        ...
        <div className="mt-12">
            <h3 className="text-[20px] leading-[30px] text-headingColor font-semibold">
                ...
                <li className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
                    ...
                    <li className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
                        <div>
                            <span className="text-irisBlueColor text-[15-px] leading-6 font-semibold">{formateDate("02-12-2015")} - {formateDate("15-07-2018")}</span>
                            <p className="text-[16px] leading-6 font-medium text-textColor">Bacharel em Pedagogia</p>
                        </div>
                            <p className="text-[14px] leading-5 font-medium text-textColor">Escola Estadual São João, Guarulhos</p>
                    </li>
